...
const verifyJWT = (req,res,next) =>{
  ...
  console.log("Cookies yang terdeteksi oleh cookie-parser:", req.cookies);
    ...
    console.log("Token yang diekstrak dari cookie:", accessToken ? "Ada (Valid/Tidaknya akan dicek)" : "KOSONG/UNDEFINED");
    ...
    if (err) {
      return res.status(401).json("Token tidak valid atau sudah expired");
    }

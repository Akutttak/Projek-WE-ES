...
async function refresh(req, res) {
    // Membaca token dari cookie agar sinkron dengan mekanisme baru Anda
...
async function logout(_req, res) {
    // Opsional: Hapus cookie dari browser/Postman saat logout
    res.clearCookie('token');
    return res.status(200).json({ message: "Logout successful. Cookie removed." });
}
